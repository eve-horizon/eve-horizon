...
import { ActionExecutorController } from './action-executor.controller.js';
...
describe('ActionExecutorController', () => {
  beforeEach(() => {
  ...
  it('quick-acks valid requests and emits runner completion in the background', async () => {
    ...
    const controller = new ActionExecutorController(service as any);
