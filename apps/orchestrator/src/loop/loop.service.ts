...
export class LoopService implements OnModuleInit, OnModuleDestroy {
  ...
  private async recoverAttemptInitTimeouts(): Promise<void> {
  ...
  private async recoverAttemptStartupTimeouts(): Promise<void> {
  ...
  private async recoverStaleRunningAttempts(): Promise<void> {
   ...
   */
  private async recoverActiveJobsWithTerminatedAttempts(): Promise<void> {
    const jobs = jobQueries(this.db);
    const gates = gateQueries(this.db);
  ...
  private async tick() {
    ...
    if (
      ...
      await this.recoverAttemptInitTimeouts();
      await this.recoverAttemptStartupTimeouts();
      await this.recoverStaleRunningAttempts();
    }
    ...
    if (
      ...
      await this.recoverActiveJobsWithTerminatedAttempts();
    }
